...
import com.atul.aluminate.MessageActivity;
import com.atul.aluminate.Model.Chats;
...
public class UsrAdapter extends RecyclerView.Adapter<com.atul.aluminate.Adapter.UsrAdapter.MyHolder> {
    ...
    public UsrAdapter(Context context, List<Users> userlist, boolean isChat) {
